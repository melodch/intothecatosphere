...
test_game.Players.update_position(pg.image.load('Cat Images/orangefront.png'), -10, 'H')
...
test_game.initialize_game()  # Initialize game and generate map
test_game.create_groups()
test_game.Players.update_position(pg.image.load('Cat Images/orangefront.png'), 10, 'V')
position = test_game.Players.get_position()
